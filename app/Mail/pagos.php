...
class pagos extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->markdown('emails.pagos.pagos')->subject('Recordatorio para el pago de la evaluación del proyecto y/o artículo'.$this->invitacion->DescripcionProyecto_Articulo)->with([
