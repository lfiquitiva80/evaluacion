...
class certificadoypago extends Mailable
{
    ...
    {
        return $this->markdown('emails.certificadoypago.certificadoypago')->subject('Confirmación de Certificado y Pago del proyecto y/o artículo '.$this->invitacion->DescripcionProyecto_Articulo)->with([
