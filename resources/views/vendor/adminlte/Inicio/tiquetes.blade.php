...
<?php  
				$tiquete= DB::table('tiquetes')->where('Id_evento',$tem->id)->get();	
				?>
...
<center>
					...
					<?php 
						...
						echo "<b>Evento :</b> ".strtoupper($tem->NombredelEvento);
					 ?></center>
...
<?php  
$participantes = DB::table('participantes')->where('Id_evento',$tem->id)
...
{!! Form::close() !!}
	...
	<P>
		<HR>
		<center>	
		<a href="{{action('principalController@participantes')}}" class="btn btn-primary btn-danger">Atras</a>
		<a href="http://192.168.15.7:809/reserva/web/day.php?" class="btn btn-primary btn-success" target="_blank">Siguiente</a></center>
