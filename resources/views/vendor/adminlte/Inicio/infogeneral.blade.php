...
@include('adminlte::layouts.menuevento')
	...
	<?php
					...
					$eventos_general=App\eventos_general::all()->where('id_user',$id_user)->last();
					//echo $tem->id;
					 ?>
...
<div class="container">
	<b><legend>INFORMACION BASICA DEL EVENTO</legend></b>
	...
	<div class="form-group">
		<label for="">id</label>
		<input type="text" class="form-control" id="id" Name="id" placeholder="Input field" value="{{$eventos_general->id}}" readonly="readonly" size="5">
	</div>

	
	<div class="form-group">
		<label for="">Tema</label>
		<input type="text" class="form-control" Name="Tema"  id="Tema" placeholder="Digite un Tema" value="{{$eventos_general->Tema}}" size="50">
	</div>

	<div class="form-group">
		<label for="">Nombre del Evento</label>
		<input type="text" class="form-control" name="NombredelEvento" id="NombredelEvento" placeholder="Digite un Nombre del Evento" value="{{$eventos_general->NombredelEvento}}" size="50">
	</div>

	<div class="form-group">
		<label for="">Lugar:</label>
		<input type="text" class="form-control" name="Lugar" id="Lugar" placeholder="Digite un Lugar" value={{$eventos_general->Lugar}}>
	</div>
...
<div class="form-group">
		<label for="">Ciudad:</label>
<select name="id_ciudad" id="id_ciudad" class="form-control" required="required" placeholder="Seleccione una Ciudad" value="{{$eventos_general->id_ciudad}}">
  ...
  @foreach($municipios as $row)
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="Ciudad_extranjero" id="Ciudad_extranjero" placeholder="Digite un Ciudad Extranjera" value="{{$eventos_general->Ciudad_extranjero}}">
	</div>

	
	<div class="form-group">
		<label for="">Fecha Inicial:</label>
		<input type="text" class="form-control" name="Fecha_inicial" id="Fecha_inicial" placeholder="" value="{{$eventos_general->	Fecha_inicial}}" >
	</div>

	<div class="form-group">
		<label for="">Fecha Final:</label>
		<input type="text" class="form-control" name="Fecha_Final" id="Fecha_Final" placeholder="" value="{{$eventos_general->Fecha_Final}}" >
	</div>
<br>
	<div class="form-group">
		<label for="">Organizador:</label>
		<input type="text" class="form-control" name="Organizador" id="Organizador" placeholder="Digite el Organizador del Evento" value="{{$eventos_general->Organizador}}">
	</div>
...
<div class="form-group" id="ocultar">
	...
	<div class="form-group">
		<label for="">Puntos claves:</label>
			<textarea class="form-control" name="Puntos_claves"  id="Puntos_claves" value="" rows="10" cols="150">{{$eventos_general->Puntos_claves}}</textarea>

	</div>


	
<center><button type="submit" class="btn btn-primary" >Actualizar</button></center><P>
...
<center>@include('adminlte::eventos_general.destroy')</center>
