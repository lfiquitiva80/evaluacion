...
<!--=====================================
		...
		<?php  
				$evento = DB::table('evento_areatematica')->where('Id_evento',$tem->id)->get();	
				?>
...
{!! Form::open(['route' => 'evento_areatematica.store', 'method'=>'POST','Class'=>'form-inline']) !!}
...
<div class="container">
	...
	<!--<div class="form-group">
		...
		<div class="form-group">
			<label for="">Id Evento: {{$tem->id}}</label>
			<input type="text" class="form-control" name="id_evento" id="id_evento" placeholder="Input field" value="{{$tem->id}}" style="visibility:hidden">
		</div>
