...
<table cellspacing="0" class="table table-bordered table-responsive">
    <tbody>
        ...
        <tr>
            ...
            <td colspan="5" style="border-color:windowtext; height:21.0pt; text-align:center; vertical-align:bottom; white-space:nowrap"><span style="font-size:11pt"><span style="font-family:&quot;Arial Narrow&quot;,sans-serif"><span style="color:black">Escuela de Administraci&oacute;n, Contadur&iacute;a y Mercadeo</span></span></span></td>
        </tr>
        <tr>
            ...
            <td colspan="5" style="border-color:windowtext; height:21.0pt; text-align:center; vertical-align:middle; "><span style="font-size:11pt"><span style="font-family:&quot;Arial Narrow&quot;,sans-serif"><span style="color:black">{{$proyectos_articulos->DescripcionProyecto_Articulo}}</span></span></span></td>
        </tr>
        <tr>
    ...
    <table class="table table-bordered table-striped table-hover table-condensed table-responsive">
        <thead style="border-color:windowtext; height:21.0pt; text-align:left; vertical-align:middle; white-space:nowrap">
            <tr>
      ...
      <!--      <tr>
            ...
            <tr>
                ...
                <td style="border-color:windowtext; height:23.25pt; text-align:justify; vertical-align:middle; white-space:normal; width:216pt"><span style="font-size:9pt"><span style="font-family:Arial,sans-serif"><span style="color:black">
                ...
                <td style="border-color:windowtext; height:21.0pt; text-align:center; vertical-align:middle; white-space:nowrap">
           ...
           <!-- <label for="">produccion</label>-->
            ...
            <!--<textarea class="form-control" name="Justificacion_Comentarios[]"  id="Justificacion_Comentarios" placeholder="Justificacion_Comentarios" rows="5" >--> <center><?php echo $row->Justificacion_Comentarios ?></center><!--</textarea>-->
        </div>
    ...
    NOTA: El puntaje mínimo para la aprobación del proyecto será de 70 puntos.aa
