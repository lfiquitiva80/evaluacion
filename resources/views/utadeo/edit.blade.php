...
-->        
        ...
        <!--<div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <input type="radio" checked name="aprobo" id="aprobo" value="1" checked>Si <input type="radio" name="aprobo" id="aprobo" value="0" >No <br>Confirmo que he diligenciado la evaluación
                @elseif($proyectos_articulos->aprobo==0)
