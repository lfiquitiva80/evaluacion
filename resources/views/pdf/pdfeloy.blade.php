...
<p style="margin-left:0cm; margin-right:0cm; text-align:center"><span style="font-size:12pt"><span style="font-family:Calibri,sans-serif"><span style="color:#231f20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; C.C No. {{$evaluadores->Cedula}}</span></span></span></p>
...
<p style="margin-left:0cm; margin-right:0cm; text-align:center"><span style="font-size:11pt"><span style="font-family:Calibri,sans-serif">{{$proyectos_articulos->DescripcionProyecto_Articulo}}</span></span></p>

<!--<p style="margin-left:0cm; margin-right:0cm; text-align:center">&nbsp;</p>-->

<p style="margin-left:0cm; margin-right:0cm; text-align:center"><span style="font-size:11pt"><span style="font-family:Calibri,sans-serif"><strong><span style="color:#231f20">Bogot&aacute;, <?php echo date("d") . " del " . date("M") . " de " . date("Y");?></span></strong></span></span></p>
