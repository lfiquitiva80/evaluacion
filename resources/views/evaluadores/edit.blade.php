...
-->
	...
	<div class="form-group">
		<div class="btn btn-default btn-file">
			<i class="fa fa-paperclip"></i> Attachment
		<label for="funcionario">Subir el Documento de Identidad <span style="color:#c0392b">(*) Campo Obligatorio </span></label>
	...
	<div class="form-group">
		<div class="btn btn-default btn-file">
			<i class="fa fa-paperclip"></i> Attachment
		<label for="funcionario">Certificado_Bancario <span style="color:#c0392b">(*) Campo Obligatorio </span></label>
	...
	<div class="form-group">
		...
		<span style="color:#c0392b">(*) Campo Obligatorio </span>
