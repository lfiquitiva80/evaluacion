...
<p style="margin-left:0cm; margin-right:0cm; text-align:justify"><span style="background-color:white"><span style="color:black"><span style="font-family:Arial, sans-serif"><span style="font-size:11pt">Reciba un cordial saludo. El Observatorio Colombiano de Ciencia y Tecnolog&iacute;a le certifica los servicios como jurado evaluador de las propuestas de investigaci&oacute;n de la {{$proponente}}</span></span><span style="font-family:Calibri, sans-serif"><span style="font-size:10.6667px">&nbsp;</span></span></span><span style="font-family:Arial,sans-serif; font-size:11pt"><span style="color:black">. </span></span></span></p>
