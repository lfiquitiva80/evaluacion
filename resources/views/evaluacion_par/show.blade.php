...
{!! Form::open(['route' => ['evaluacion_par.update', $evaluacion_par->id],'method'=>'PATCH']) !!}
	...
	<legend>VISTA INFORMACION EVALAUCION PAR</legend>
 ...
 <a href="{{ route('evaluacion_par.index') }}" class="btn btn-primary" >Regresar</a><p>
	...
	<div class="form-group">
		...
		<input type="hidden" class="form-control" name="id"  id="id" placeholder="Id" readonly="readonly" value="{{$evaluacion_par->id}}">
	</div>
...
Nota: Los puntajes no son acumulables. Se debe tomar como medida el mayor nivel de formación académica presentado."     
      ...
      <div class="form-group">
		...
		<textarea class="form-control" name="justificacion_formacion_recurso_humano" id="justificacion_formacion_recurso_humano" placeholder="justificacion_formacion_recurso_humano" rows="10">{{$evaluacion_par->justificacion_formacion_recurso_humano}}</textarea>
	</div>          
            </td>
        </tr>
